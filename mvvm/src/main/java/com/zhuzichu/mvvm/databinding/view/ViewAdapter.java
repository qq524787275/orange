...
import com.zhuzichu.mvvm.utils.DensityUtilsKt;
...
public class ViewAdapter {
    ...
    public static void setWidthHeightRatio(final View view, final float ratio, final int padding) {
        ViewGroup.LayoutParams layoutParams = view.getLayoutParams();

        layoutParams.width = DensityUtilsKt.getScreenW() - DensityUtilsKt.dip2px(padding);
