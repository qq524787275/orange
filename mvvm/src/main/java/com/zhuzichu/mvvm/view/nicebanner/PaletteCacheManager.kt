...
class PaletteCacheManager {
    ...
    private var creativePagerAdapter: INicePagerAdapter? = null
    ...
    private class CachePalettesAsync(
        val paletteCacheManager: PaletteCacheManager,
        val creativePagerAdapter: INicePagerAdapter?, val position: Int,
        val onPaletteCachedListener: (Int) -> Unit
    ...
    fun setCreativeViewAdapter(creativePagerAdapter: INicePagerAdapter?) {
