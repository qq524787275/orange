package com.zhuzichu.mvvm.view.magicindicator.buildins.commonnavigator.titles;
...
public class ClipPagerTitleView extends View implements IMeasurablePagerTitleView {
    ...
    private void init(Context context) {
        int textSize = (int) UIUtil.dip2px(context, 16);
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setTextSize(textSize);
        int padding = (int) UIUtil.dip2px(context, 10);
