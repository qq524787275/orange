...
class ZoomableImageView : ImageView {
    ...
    val scrollPosition: PointF?
        get() {
            ...
            val point =
                transformCoordTouchToBitmap(x = viewSize.width / 2, y = viewSize.height / 2, clipToBitmap = true)
    ...
    private inner class GestureListener : GestureDetector.SimpleOnGestureListener() {
        ...
        override fun onDoubleTap(event: MotionEvent): Boolean {
            ...
            if (state == State.NONE) {
                ...
                val doubleTap =
                    DoubleTapZoom(targetZoom, focusX = event.x, focusY = event.y, stretchImageToSuper = false)
