package com.zhuzichu.mvvm.view.imageview
...
class CircularImageView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    override fun setScaleType(scaleType: ScaleType) {
        require(!(scaleType != CENTER_CROP && scaleType != CENTER_INSIDE)) { String.format("ScaleType %s not supported. " + "Just ScaleType.CENTER_CROP & ScaleType.CENTER_INSIDE are available for this library.", scaleType) }
    }
    //endregion
    ...
    private fun update() {
        ...
        heightCircle = usableWidth.coerceAtMost(usableHeight)
