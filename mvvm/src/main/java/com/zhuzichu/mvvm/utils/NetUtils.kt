...
//            Log.d("----result---", "result = " + result);
    ...
    fun isWifiEnabled(context: Context): Boolean {
        ...
        return ((mgrConn.activeNetworkInfo != null
                && mgrConn.activeNetworkInfo.state == State.CONNECTED)
    ...
    fun isGpsEnabled(context: Context): Boolean {
        ...
        val accessibleProviders: List<String?>? = lm.getProviders(true)
        return accessibleProviders != null && accessibleProviders.isNotEmpty()
    }
