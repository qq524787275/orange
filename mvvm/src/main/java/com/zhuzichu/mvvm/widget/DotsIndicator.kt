...
import com.zhuzichu.mvvm.utils.tint
import com.zhuzichu.mvvm.view.banner.ViewPagerLayoutManager
...
class DotsIndicator(
        ...
        this.recyclerView?.let {
            if (it.adapter != null) {
                ...
                if (layoutManager is ViewPagerLayoutManager) {
                    ...
                    layoutManager.setOnPageChangeListener(internalPageChangeListener)
                    internalPageChangeListener.onPageSelected(layoutManager.currentPosition)
                }
    ...
    private fun currentItem() = viewpagerlayoutmanager?.currentPosition ?: -1

    private val internalPageChangeListener = object : ViewPagerLayoutManager.OnPageChangeListener {
