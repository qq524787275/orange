package com.zhuzichu.mvvm.downloader.core

import android.content.Context
import android.os.AsyncTask
import android.util.Pair
import com.zhuzichu.mvvm.downloader.core.database.DownloaderDao
import com.zhuzichu.mvvm.downloader.core.model.DownloaderData
import com.zhuzichu.mvvm.downloader.core.model.StatusModel
import com.zhuzichu.mvvm.downloader.helper.ConnectCheckerHelper
import com.zhuzichu.mvvm.downloader.helper.ConnectionHelper
...
internal data class DownloadTask(
    ...
    private fun detectFileName() {
        ...
        if (fileName == null) {
            ...
            extension = MimeUtils.guessExtensionFromMimeType(contentType)
        }
    }
}